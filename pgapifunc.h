...
enum {
	...
	,SQL_ATTR_PGOPT_UNKNOWNSIZES
	,SQL_ATTR_PGOPT_TEXTASLONGVARCHAR
	,SQL_ATTR_PGOPT_UNKNOWNSASLONGVARCHAR
	,SQL_ATTR_PGOPT_BOOLSASCHAR
	,SQL_ATTR_PGOPT_MAXVARCHARSIZE
	,SQL_ATTR_PGOPT_MAXLONGVARCHARSIZE
};
